    ...
    const getItems = [
        {
            ...
            text: 'Nesse momento, você pode achar que já deve ir à maternidade, mas calma! Essa fase pode demorar um tempo muito variável, as contrações uterinas são dolorosas, mas podem estar com duração e intervalos entre elas ainda irregulares e a dilatação do colo do útero chega até 4 cm.',
            video: '',
            item_id: 1,
        },
        {
            ...
            text: 'Agora sim, podemos dizer que começou o trabalho de parto! As contrações uterinas são regulares, aparecem num intervalo semelhante entre elas, e há dilatação do colo do útero progressiva a partir dos 4 cm até os 10 cm. Nas mães de primeira viagem dura em média 8 horas e é pouco provável que dure mais que 18 horas; nas mulheres que já pariram dura em média 5 horas e é pouco provável que dure mais que 12 horas.',
            video: '',
            item_id: 2,
        },
        {
            ...
            text: 'Ufa! Já estamos com os tão sonhados 10 cm, que é a dilatação total do colo, mas sem sensação de vontade de fazer força para expulsar o bebê. Seu corpo está se preparando para que o bebê comece a descer pelo canal do parto. Até o momento não falamos em que período a bolsa das águas (membrana amniótica) rompe no trabalho de parto. Vamos lá! A bolsa pode romper antes das contrações iniciarem, porém, o mais comum é que isso aconteça após o início delas e até no momento do nascimento. Alguns bebês podem nascer sem que a bolsa rompa e chamamos esse parto de empelicado.',
            video: '',
            item_id: 3,
        },
        {
